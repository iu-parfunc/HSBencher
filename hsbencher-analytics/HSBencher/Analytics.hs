...
renderPlot s pl =
  ...
  where
    ...
    chartLines (v:vs) (l:ls)
      = ("{\n data: "++ v ++ ",\n" ++
         "lines: { show: true, fill: false, lineWidth: 6 },\n" ++
         (if (isJust (lgSymbol l))
          then "points: { show: true, radius: 8 },\n" 
          else "") ++ 
    ...
    plotOptions
      = "var options = {canvas: true," ++ 
                       "legend: {position: \"nw\", type: \"canvas\",color : \"#000000\", weight: \"bold\"  }," ++
...
html js =
  ...
  "<div id=\"content\">\n" ++ 
  "<div id=\"placeholder\" style=\"width:1600px;height:800px\"></div>\n" ++ 
